...
class GoogleTrendsScraper:
    ...
    def get_trend_data(self, keyword: str) -> Optional[Dict]:
        ...
        try:
            ...
            if interest_df.empty or clean_keyword not in interest_df.columns:
                logger.warning(f"No trend data found for: {clean_keyword}")
                return None
            ...
            if len(values) >= 30:
                ...
                velocity = ((recent_avg - previous_avg) / max(previous_avg, 1)) * 100
            else:
                velocity = 0
